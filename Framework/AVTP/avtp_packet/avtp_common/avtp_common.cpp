 ...
 * @return	   成功返回OK  失败返回ERROR
 */
static INT32 avtp_get_field_value(const AVTP_STREAM_PDU_T *pStAvtpStreamPdu,AVTP_STREAM_FIELD_E eField, UINT64 *uVal)
{
    INT32 iRet = OK;
	UINT32 uBitmap = 0;
    UINT32 uMask = 0;
 ...
 * @return	   成功返回OK  失败返回ERROR
 */
static INT32 avtp_set_field_value(AVTP_STREAM_PDU_T *pStAvtpStreamPdu,AVTP_STREAM_FIELD_E eField, UINT64 uVal)
{
	UINT32 uBitmap = 0;
    UINT32 uMask = 0;
    UINT8 uShift = 0;
