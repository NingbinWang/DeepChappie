 ...
 */
INT32 sys_time_get_msec(UINT64 *uMSecond);
 ...
 * @return     成功返回 OK 错误返回 ERROR, 支持通过get_last_errno获取错误码
 */
INT32 sys_time_get_sec(UINT32 *uSecond);
 ...
 */
INT32 sys_time_get_utc_sec(UINT32 *uSecond);
 ...
 * @return     成功返回 OK  错误返回 ERROR, 支持通过get_last_errno获取错误码
 */
INT32 sys_time_get_utc_msec(UINT64 *uUtcMSec);
 ...
 * @return     成功返回 ok  错误返回 ERROR, 支持通过get_last_errno获取错误码
 */
INT32 sys_time_set_utc_msec(UINT64 uUtcSec);
