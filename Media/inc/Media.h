...
//extParam的bit位定义
#define HIK_PACK_4BYTES_ALIGN		((1u)<<0) //是否4字节对齐
#define HIK_PACK_PRIVT_STREAM		((1u)<<1) //是否包含私有流
#define HIK_PACK_MEGA_PS		    ((1u)<<2) //是否是PS
#define HIK_PACK_SYS_HAEDER		    ((1u)<<3) //是否包含system header
