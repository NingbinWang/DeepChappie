 ...
 * @return     成功返回OK     失败返回错误码
 */
static INT32 avb_1722_talker_avtp_h264_instance(AVB_1722_TALKER_PRIV_DATA_T *pStPrivData)
{
    INT32 iRet = ERROR;
    if(NULL == pStPrivData)
    {
 ...
 * @return     成功返回OK  失败返回错误码
 */
static INT32 avb_1722_talker_send_ctrl_msg(AVB_1722_TALKER_PRIV_DATA_T *pStPrivData, AVB_1722_TALKER_CMD_E eCmd)
{
    INT32 iRet = ERROR;
 ...
 */
static INT32 avb_1722_talker_recv_msg_handle(AVB_1722_TALKER_PRIV_DATA_T *pStPrivData, AVB_1722_TALKER_MSG_T *pStMsg)
{
    INT32 iRet = ERROR;
 ...
 */
static INT32 avb_1722_talker_set_param(IAVB1722Talker *pIAVB1722Talker, AVB_1722_TALKER_SET_PARAM_T *pStParam)
{
    INT32 iRet = ERROR;
    UINT32 uFrameBufSize = 0; 
    AVB_1722_TALKER_PRIV_DATA_T *pStPrivData = NULL;
 ...
 * @return     成功返回OK     失败返回错误码
 */
static INT32 avb_1722_talker_start(IAVB1722Talker *pIAVB1722Talker)
{
    INT32 iRet = ERROR;
    AVB_1722_TALKER_PRIV_DATA_T *pStPrivData = NULL;
 ...
 * @return     成功返回OK     失败返回错误码
 */
static INT32 avb_1722_talker_stop(IAVB1722Talker *pIAVB1722Talker)
{
    INT32 iRet = ERROR; 
    AVB_1722_TALKER_PRIV_DATA_T *pStPrivData = NULL;
 ...
 * @return     成功返回OK     失败返回错误码
 */
static INT32 avb_1722_talker_get_state(IAVB1722Talker *pIAVB1722Talker, AVB_TALKER_STATE_E *pState)
{
    INT32 iRet = ERROR; 
    AVB_1722_TALKER_PRIV_DATA_T *pStPrivData = NULL;
 ...
 * @return     成功返回OK  失败返回错误码
 */
static INT32 avb_1722_talker_init_priv_data(AVB_1722_TALKER_PRIV_DATA_T *pStPrivData)
{
    INT32 iRet = ERROR;
