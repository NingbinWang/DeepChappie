 ...
 */
static INT32 network_manager_init(INetwork *pINetwork_manager,const CHAR *strIP,const CHAR *strNetMask, const CHAR *strGateWay)
{
 ...
 * @return     成功返回OK  失败返回错误码
 */
static INT32 network_manager_up(INetwork *pINetwork_manager)
{
    NETWORK_PRIV_DATA_T *pStPrivData = NULL;
    INT32 iRet = 0;
    pStPrivData = network_manage_get_priv_data(pINetwork_manager);
 ...
 * @return     成功返回OK  失败返回错误码
 */
static INT32 network_manager_down(INetwork *pINetwork_manager)
{
    NETWORK_PRIV_DATA_T *pStPrivData = NULL;
    INT32 iRet = ERROR;
    pStPrivData = network_manage_get_priv_data(pINetwork_manager);
 ...
 * @return     成功返回OK     失败返回错误码
 */
static INT32 network_manager_release(INetwork *pINetwork_manager)
{
    NETWORK_BASE_T *pStBase = NULL;
    pStBase = (NETWORK_BASE_T*)pINetwork_manager;
