#ifndef __AVTP_UTIL_H__
#define __AVTP_UTIL_H__
#include <arpa/inet.h>
#include "sys_common.h"
#define BIT(n)				(1ULL << n)
#define BITMASK(len)		(BIT(len) - 1u)
 ...
 */
#define BITMAP_GET_VALUE(bitmap, mask, shift)  ((bitmap & mask) >> shift)

/* Set the value 'val' in the 'bitmap' variable at the position represented by
 * 'mask'.
 */
#define BITMAP_SET_VALUE(bitmap, val, mask, shift)  (bitmap = (bitmap & ~mask) | ((val << shift) & mask))
