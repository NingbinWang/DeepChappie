 ...
 */
static INT gsensor_manager_send_ctrl_msg(GSENSOR_MANAGER_PRIV_DATA_T *pStPrivData, GSENSOR_MANAGER_CMD_E eCmd)
{
    INT iRet = ERROR;
    UINT uWaitMsec = 2000;
 ...
 */
static INT gsensor_manager_recv_msg_handle(GSENSOR_MANAGER_PRIV_DATA_T *pStPrivData, GSENSOR_MANAGER_MSG_T *pStMsg)
{
    INT iRet = ERROR;
    if((NULL == pStPrivData) || (NULL == pStMsg))
    {
 ...
 * @return	   返回极大值
 */
static INT gsensor_manager_maxval(const UINT16 validnum)
{
 ...
 * @return	   返回正负数
 */
static INT gsensor_manager_convert(const INT maxval,INT data)
{
    if(data < maxval){
        return data;
    }else{
 ...
 * @return     成功返回OK     失败返回错误码
 */
static INT gsensor_manager_init(IGsensor_manager *pIGsensor_manager)
{
    INT iRet = ERROR;
 ...
 * @return     成功返回OK     失败返回错误码
 */
static INT gsensor_manager_start(IGsensor_manager *pIGsensor_manager)
{
    INT iRet = ERROR;
    GSENSOR_MANAGER_PRIV_DATA_T *pStPrivData = NULL;
 ...
 * @return     成功返回OK     失败返回错误码
 */
static INT gsensor_manager_stop(IGsensor_manager *pIGsensor_manager)
{
     INT iRet = ERROR;
    GSENSOR_MANAGER_PRIV_DATA_T *pStPrivData = NULL;
 ...
 * @return     成功返回OK     失败返回错误码
 */
static INT gsensor_manager_get_state(IGsensor_manager *pIGsensor_manager, GSENSOR_MANAGER_STATE_E *pState)
{
    INT iRet = ERROR;
    GSENSOR_MANAGER_PRIV_DATA_T *pStPrivData = NULL;
 ...
 * @return     成功返回OK     失败返回错误码
 */
static INT gsensor_manager_get_data(IGsensor_manager *pIGsensor_manager,Sensordata_t *data)
{
    INT iRet = ERROR;
    GSENSOR_MANAGER_PRIV_DATA_T *pStPrivData = NULL;
 ...
 * @return     成功返回OK     失败返回错误码
 */
static INT gsensor_manager_release(IGsensor_manager *pIGsensor_manager)
{
     INT iRet = ERROR;
     GSENSOR_MANAGER_PRIV_DATA_T *pStPrivData = NULL;
     pStPrivData = gsensor_manager_get_priv_data(pIGsensor_manager);
 ...
 * @return     成功返回OK  失败返回错误码
 */
static INT gsensor_manager_interface(IGsensor_manager *pIGsensor_manager)
{
 ...
 * @return     成功返回OK  失败返回错误码
 */
static INT gsensor_manager_init_priv_data(GSENSOR_MANAGER_PRIV_DATA_T *pStPrivData)
{
    sensorinfo_t *pinfo;
    INT iRet = ERROR;
     INT iFd = 0;
