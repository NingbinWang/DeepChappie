 ...
 */
INT medium_manager_mount(const char *strMountPath, const char *strDevPath)
{
    INT iRet = -1;
    INT iIndex = 0;
 ...
 */
MEDIUM_INFO_NODE_T *medium_manager_find_medium_node(MEDIUM_MANAGER_PRIV_DATA_T *pStPrivData,INT iMediumChn)
{
 ...
 * @return	   成功结点指针  失败空
 */
MEDIUM_PART_INFO_T *medium_manager_find_medium_part(MEDIUM_MANAGER_PRIV_DATA_T *pStPrivData, INT iMediumNo, INT iPartNo)
{
 ...
 * @return	   存储状态
 */
INT medium_manager_check_medium_read_write(MEDIUM_PART_INFO_T  *pStPartNode)
{
    INT                       iRet                  = ERROR;
 ...
 * @return     无
 */
VOID medium_manager_msg_callback(DEV_MONITOR_TYPE_E eType, INT iDevIndex, INT iPartIndex, DEV_MONITOR_ACTION_E eAction)
{
    MEDIUM_MANAGER_PRIV_DATA_T *pStPrivData = NULL;
    MEDIUM_MANAGER_MSG_T stMediumMsg = {0};
    IMediumManager *pIMediumManager = NULL;
    pIMediumManager = medium_manager_get_instance();
     INT iRet = ERROR;
 ...
 */
INT medium_manager_check_capacity(MEDIUM_PART_INFO_T *pStPartNode,MEDIUM_INFO_NODE_T *pStNode)
{
    INT iRet = ERROR;
 ...
 * @return	   无
 */
INT medium_manager_init_dev_path(MEDIUM_TYPE_E eType, MEDIUM_PART_INFO_T *pStNode)
{
    CHAR strDriver = 'a';
	if( NULL == pStNode )
	{
 ...
 * @return	   成功返回OK  失败返回错误码
 */
INT  medium_manager_init(IMediumManager *pIMediumManager,unsigned char uMediumId,unsigned char uPartId)
{
    MEDIUM_MANAGER_PRIV_DATA_T *pStPrivData = NULL;
    INT iRet = ERROR;
 ...
 * @return	   成功返回OK  失败返回错误码
 */
INT medium_manager_start(IMediumManager *pIMediumManager)
{
    INT iRet = ERROR;
 ...
 * @return	   成功 0 ,失败返回 -1
 */
INT medium_manager_format_part(MEDIUM_MANAGER_PRIV_DATA_T *pStPrivData, MEDIUM_PART_INFO_T *pStPartInfo, MEDIUM_FORMAT_TYPE_E eType, UINT uClusterSize)
{
    INT  iRet = ERROR;
 ...
 * @return	   成功 0 ,失败返回 -1
 */
INT medium_manager_format_handle_tf_card(MEDIUM_MANAGER_PRIV_DATA_T *pStPrivData, MEDIUM_PART_INFO_T *pStPartNode, MEDIUM_FORMAT_TYPE_E eType)
{
    INT  iRet = ERROR;
    CHAR strDriver ='a';
 ...
 * @return	   成功返回OK  失败返回错误码
 */
INT medium_manager_format(IMediumManager *pIMediumManager, INT iMediumChan, MEDIUM_FORMAT_TYPE_E eType)
{
    INT iRet = ERROR;
    MEDIUM_MANAGER_PRIV_DATA_T *pStPrivData = NULL;
    MEDIUM_INFO_NODE_T *pStNode = NULL;
 ...
 * @return	   成功返回OK  失败返回错误码
 */
INT medium_manager_init_priv_data(MEDIUM_MANAGER_PRIV_DATA_T *pStPrivData)
{
    INT iRet = ERROR;
 ...
 * @return	   成功返回OK  失败返回错误码
 */
INT medium_manager_init_interface(IMediumManager *pIMediumManager)
{
    INT iRet = ERROR;
