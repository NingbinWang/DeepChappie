 ...
 */
static INT32 avtp_pdu_init_sub_instance_cvf(AVTP_PDU_PRIV_DATA_T *pStPrivData)
{
    INT32 iRet = ERROR;
 ...
 * @return	   成功返回OK  失败返回错误码
 */
static INT32 avtp_pdu_init_sub_instance(AVTP_PDU_PRIV_DATA_T *pStPrivData, AVTP_PDU_SUBTYPE_E eSubType)
{
    INT32 iRet = ERROR;
 ...
 * @return	   成功返回OK  失败返回错误码
 */
static INT32 avtp_pdu_set_subtype(IAvtpPdu *pIAvtpPdu, AVTP_PDU_SUBTYPE_E eSubType)
{
    INT32 iRet = ERROR;
 ...
 * @return	   成功返回OK  失败返回错误码
 */
static INT32 avtp_pdu_get_subtype(IAvtpPdu *pIAvtpPdu, AVTP_PDU_SUBTYPE_E *pSubType)
{
    AVTP_PDU_PRIV_DATA_T *pStPrivData = NULL;
 ...
 * @return	   成功返回OK  失败返回错误码
 */
static INT32 avtp_pdu_cvf_field_set(AVTP_PDU_PRIV_DATA_T *pStPrivData, UINT8 uFieldType, UINT64 uVal)
{
    INT32 iRet = ERROR;
 ...
 * @return	   成功返回OK  失败返回错误码
 */
static INT32 avtp_pdu_field_set(IAvtpPdu *pIAvtpPdu, UINT8 uFieldType, UINT64 uVal)
{
    INT32 iRet = ERROR;
    AVTP_PDU_PRIV_DATA_T *pStPrivData = NULL;
 ...
 * @return	   成功返回OK  失败返回错误码
 */
static INT32 avtp_pdu_cvf_field_get(AVTP_PDU_PRIV_DATA_T *pStPrivData, UINT8 uFieldType, UINT64 *pVal)
{
    INT32 iRet = ERROR;
 ...
 * @return	   成功返回OK  失败返回错误码
 */
static INT32 avtp_pdu_field_get(IAvtpPdu *pIAvtpPdu, UINT8 uFieldType, UINT64 *pVal)
{
    INT32 iRet = ERROR;
    AVTP_PDU_PRIV_DATA_T *pStPrivData = NULL;
 ...
 * @return     成功返回OK  失败返回错误码
 */
static INT32 avtp_pdu_cvf_payload_set(AVTP_PDU_PRIV_DATA_T *pStPrivData, UINT8 *pPayloadData, UINT32 uDataLength)
{
    INT32 iRet = ERROR;
 ...
 * @return     成功返回OK  失败返回错误码
 */
static INT32 avtp_pdu_payload_set(IAvtpPdu *pIAvtpPdu, UINT8 *pPayloadData, UINT32 uDataLength)
{
    INT32 iRet = ERROR;
    AVTP_PDU_PRIV_DATA_T *pStPrivData = NULL;
 ...
 */
static UINT8 *avtp_pdu_cvf_payload_get(AVTP_PDU_PRIV_DATA_T *pStPrivData, UINT32 *uLength)
{
    if((NULL == pStPrivData) || (NULL == pStPrivData->pCVFInstance))
    {
        AVTP_ERROR("param error\n");
 ...
 * @return     成功返回payload数据首地址，失败返回NULL
 */
static UINT8 *avtp_pdu_payload_get(IAvtpPdu *pIAvtpPdu, UINT32 *uLength)
{
    AVTP_PDU_PRIV_DATA_T *pStPrivData = NULL;
    UINT8 *pPayLoad = NULL;
 ...
 */
static UINT8 *avtp_pdu_cvf_serial(AVTP_PDU_PRIV_DATA_T *pStPrivData, UINT32 *uLength)
{
    if((NULL == pStPrivData) || (NULL == pStPrivData->pCVFInstance))
    {
        AVTP_ERROR("param error\n");
 ...
 * @return     成功返回序列化后avtp包地址，失败返回NULL
 */
static UINT8 *avtp_pdu_serial(IAvtpPdu *pIAvtpPdu, UINT32 *uLength)
{
    AVTP_PDU_PRIV_DATA_T *pStPrivData = NULL;
    UINT8 *pAvtpdu = NULL;
 ...
 */
static INT32 avtp_pdu_cvf_deserial(AVTP_PDU_PRIV_DATA_T *pStPrivData, UINT8 *pAvtpData, UINT32 uAvtpDataLength)
{
 ...
 * @return     成功返回序列化长度   失败返回<0
 */
static INT32 avtp_pdu_deserial(IAvtpPdu *pIAvtpPdu, UINT8 *pAvtpData, UINT32 uAvtpDataLength)
{
    INT32 iRet = ERROR;
    UINT8 uSubType = 0;
    AVTP_PDU_PRIV_DATA_T *pStPrivData = NULL;
 ...
 * @return     成功返回OK  失败返回错误码
 */
static INT32 avtp_pdu_init_interface(IAvtpPdu *pIAvtpPdu)
{
    if(NULL == pIAvtpPdu)
    {
        AVTP_ERROR("param error\n");
 ...
 * @return     成功返回OK  失败返回错误码
 */
static INT32 avtp_pdu_init_priv_data(AVTP_PDU_PRIV_DATA_T *pStPrivData, const UINT32 uPduLength)
{
    INT32 iRet = ERROR;
    VOID *pMemset = NULL;
    if(NULL == pStPrivData)
